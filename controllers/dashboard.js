...
// Functions
let numberWithCommas = require("../bin/userPermissions/numberWithCommas");
...
router.get("/", isLoggedIn, async function(req, res){ 
	...
	res.render("dashboard", {ytd_income: ytd_income, clients_added: clients_added, jobs_added: jobs_added, transaction_data: transaction_data, jobs_data: jobs_data});	
});	
